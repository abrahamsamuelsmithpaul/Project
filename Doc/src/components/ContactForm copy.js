...
const ContactForm = (props) => {
    ...
    return (
        <form autoComplete="off" onSubmit={handleFormSubmit}>
            ...
            <div className="form-group">
                            <div className="form-field">
                              <div className="select-wrap">
                                <div className="icon"><span className="ion-ios-arrow-down"  onChange={e=>this.setState({time:e.target.value})}/></div>
            ...
            <div className="form-group">
               <input className="form-control" name="slot" placeholder="Please Book slot"
                    value={values.slo }
                    onChange={handleInputChange}
                />
            </div>
